...
let Co2okWidget = {
  ...
  widgetGenerator: function (widgetContainer, totalCompensatedData) {
      ...
      fileref.setAttribute("rel", "stylesheet")
      fileref.setAttribute("type", "text/css")
      fileref.setAttribute("href", `${SITE_HOST}/widget/co2okWidgetMark-5fd605ff.css`)
      document.getElementsByTagName("head")[0].appendChild(fileref)
      ...
      if (document.cookie.match(/^(.*;)?\s*co2ok_hide_button\s*=\s*[^;]+(.*)?$/)){
        ...
        return
              ...
              <div class="btn_co2ok_widget co2ok_widget_info" href="#">
                  <span class="btn_co2ok_widget co2ok_widget_info">SHOP<img class="logo_co2ok_widget" src="${SITE_HOST}/static/logo-gray.png"></span>
              </div>
