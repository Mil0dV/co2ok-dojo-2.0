...
let Co2okWidget = {
    ...
    var stepThree = `Together we offset <strong class="co2ok-widget-card">${compensationAmount} </strong>tonnes of CO₂ emissions. This is equal to <strong class="co2ok-small">${(compensationAmount * 5000).toFixed(0)} </strong>km of flying`;
